...
export class DatabaseException extends HttpException {
  constructor(message: string, statusCode: HttpStatus = HttpStatus.InternalServerError) {
...
export function mapSupabaseError(error: any): DatabaseException {
  ...
  switch (code) {
    ...
    case 'PGRST000':
      return new DatabaseConnectionException(message || 'Database connection failed');
    default:
