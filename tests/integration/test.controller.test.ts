...
describe('Test Controller', () => {
  describe('GET /test/400', () => {
    it('should return 400 Bad Request', async () => {
      ...
      await SupertestHelpers.expectBadRequestResponse(response, 'Bad Request - Test endpoint');
    });
  });
  ...
  describe('GET /test/401', () => {
    it('should return 401 Unauthorized', async () => {
      ...
      await SupertestHelpers.expectUnauthorizedResponse(response, 'Unauthorized - Test endpoint');
    });
  });
  ...
  describe('GET /test/403', () => {
    it('should return 403 Forbidden', async () => {
      ...
      await SupertestHelpers.expectForbiddenResponse(response, 'Forbidden - Test endpoint');
    });
  });
  ...
  describe('GET /test/404', () => {
    it('should return 404 Not Found', async () => {
      ...
      await SupertestHelpers.expectNotFoundResponse(response, 'Not Found - Test endpoint');
    });
  });
  ...
  describe('GET /test/409', () => {
    it('should return 409 Conflict', async () => {
      ...
      await SupertestHelpers.expectConflictResponse(response, 'Conflict - Test endpoint');
    });
  });
  ...
  describe('GET /test/422', () => {
    it('should return 422 Unprocessable Entity', async () => {
      ...
      await SupertestHelpers.expectValidationErrorResponse(response, 'Unprocessable Entity - Test endpoint');
    });
  });
  ...
  describe('GET /test/500', () => {
    it('should return 500 Internal Server Error', async () => {
      ...
      await SupertestHelpers.expectInternalServerErrorResponse(response, 'Internal Server Error - Test endpoint');
    });
  });
  ...
  describe('Error Response Structure', () => {
    it('should return consistent error response structure for all test endpoints', async () => {
      const testCases = [
        ...
        { endpoint: '/test/422', expectedStatus: HttpStatus.UnprocessableEntity },
        { endpoint: '/test/500', expectedStatus: HttpStatus.InternalServerError },
      ];
