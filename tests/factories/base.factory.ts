...
export class BaseFactory {
  ...
  static createDeletedEntity(overrides: Partial<IBaseEntity> = {}): IBaseEntity {
  ...
  static createMultipleEntities(count: number, overrides: Partial<IBaseEntity> = {}): IBaseEntity[] {
